...
st.markdown("<p style='font-size:20px; color:navy;'>Enter House Size </p>",unsafe_allow_html=True)
size = st.number_input("",min_value=500, max_value=5000000, step=100)

st.markdown("<p style='font-size:20px; color:navy;'>Number of Bedroom</p>",unsafe_allow_html=True)
bed = st.slider("", 2, 10, 2)

st.markdown("<p style='font-size:20px; color:navy;'>Number of Bathroom</p>",unsafe_allow_html=True)
bath = st.slider("", 1, 5, 2)

st.markdown("<p style='font-size:20px; color:navy;'>Age of House(years)</p>",unsafe_allow_html=True)
